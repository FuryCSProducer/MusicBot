...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='FuryCSProducer/MusicBot ({})'.format(BOTVERSION), icon_url='https://cdn.discordapp.com/attachments/598790956203900960/728914106161299466/LEM-20.jpg')
        e.set_author(name=self.user.name, url='https://github.com/FuryCSProducer/MusicBot', icon_url=self.user.avatar_url)
        return e
